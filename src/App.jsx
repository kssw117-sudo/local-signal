...
export default function LocalSEOKit() {
  ...
  const CATEGORY_OPTIONS_BY_LANG = {
      ...
      ru: ["Кофейня", "Ресторан", "Кафе", "Пекарня", "Бар", "Пиццерия", "Парикмахерская", "Барбершоп", "Ногтевой салон", "Спа", "Массажист", "Спортзал", "Йога-студия", "Стоматолог", "Врач", "Аптека", "Ветеринар", "Автосервис", "Автомойка", "Цветочный магазин", "Зоомагазин", "Книжный магазин", "Магазин одежды", "Ювелирный магазин", "Магазин мебели", "Хозяйственный магазин", "Юридическая фирма", "Бухгалтерская фирма", "Агентство недвижимости", "Страховое агентство", "Фотостудия", "Тату-салон", "Химчистка", "Служба замков", "Клининговая служба", "Ландшафтная компания", "Сантехник", "Электрик", "Компания по вентиляции и кондиционированию", "Переезды", "Детский сад", "Центр репетиторства", "Автошкола", "Организация мероприятий", "Кейтеринг", "Фудтрак"],
      ar: ["مقهى", "مطعم", "كافيه", "مخبز", "حانة", "مطعم بيتزا", "صالون تصفيف شعر", "صالون حلاقة", "صالون أظافر", "سبا", "معالج تدليك", "صالة رياضية", "استوديو يوغا", "طبيب أسنان", "طبيب", "صيدلية", "طبيب بيطري", "ورشة سيارات", "مغسلة سيارات", "محل زهور", "متجر حيوانات أليفة", "مكتبة", "متجر ملابس", "متجر مجوهرات", "متجر أثاث", "متجر أدوات", "مكتب محاماة", "مكتب محاسبة", "وكالة عقارية", "وكالة تأمين", "استوديو تصوير", "محل وشم", "مغسلة ملابس", "محل أقفال", "خدمة تنظيف", "شركة تنسيق حدائق", "سباك", "كهربائي", "شركة تكييف وتدفئة", "شركة نقل أثاث", "حضانة أطفال", "مركز دروس خصوصية", "مدرسة تعليم قيادة", "منظم فعاليات", "خدمة تموين طعام", "عربة طعام متنقلة"],
      fa: ["کافی‌شاپ", "رستوران", "کافه", "نانوایی", "بار", "پیتزافروشی", "آرایشگاه", "سلمانی", "سالن ناخن", "اسپا", "ماساژور", "باشگاه ورزشی", "استودیو یوگا", "دندانپزشک", "پزشک", "داروخانه", "دامپزشک", "تعمیرگاه خودرو", "کارواش", "گل‌فروشی", "فروشگاه حیوانات خانگی", "کتاب‌فروشی", "فروشگاه پوشاک", "جواهرفروشی", "فروشگاه مبلمان", "فروشگاه ابزار", "دفتر وکالت", "دفتر حسابداری", "آژانس املاک", "آژانس بیمه", "استودیو عکاسی", "استودیو خالکوبی", "خشکشویی", "کلیدسازی", "خدمات نظافت", "شرکت باغبانی", "لوله‌کش", "برقکار", "شرکت تهویه مطبوع", "شرکت اسباب‌کشی", "مهدکودک", "مرکز تدریس خصوصی", "آموزشگاه رانندگی", "برنامه‌ریز رویداد", "خدمات پذیرایی", "کامیون غذا"],
      es: ["Cafetería", "Restaurante", "Café", "Panadería", "Bar", "Pizzería", "Peluquería", "Barbería", "Salón de uñas", "Spa", "Masajista", "Gimnasio", "Estudio de yoga", "Dentista", "Médico", "Farmacia", "Veterinario", "Taller mecánico", "Autolavado", "Floristería", "Tienda de mascotas", "Librería", "Tienda de ropa", "Joyería", "Tienda de muebles", "Ferretería", "Bufete de abogados", "Estudio contable", "Agencia inmobiliaria", "Agencia de seguros", "Estudio fotográfico", "Estudio de tatuajes", "Tintorería", "Cerrajería", "Servicio de limpieza", "Empresa de jardinería", "Fontanero", "Electricista", "Empresa de climatización", "Empresa de mudanzas", "Guardería", "Centro de tutoría", "Autoescuela", "Organizador de eventos", "Servicio de catering", "Food truck"],
      fr: ["Café", "Restaurant", "Bistrot", "Boulangerie", "Bar", "Pizzeria", "Salon de coiffure", "Barbier", "Salon de manucure", "Spa", "Masseur", "Salle de sport", "Studio de yoga", "Dentiste", "Médecin", "Pharmacie", "Vétérinaire", "Garage automobile", "Lavage auto", "Fleuriste", "Animalerie", "Librairie", "Boutique de vêtements", "Bijouterie", "Magasin de meubles", "Quincaillerie", "Cabinet d’avocats", "Cabinet comptable", "Agence immobilière", "Agence d’assurance", "Studio photo", "Salon de tatouage", "Pressing", "Serrurerie", "Service de nettoyage", "Entreprise de paysagisme", "Plombier", "Électricien", "Entreprise de climatisation", "Entreprise de déménagement", "Garderie", "Centre de soutien scolaire", "Auto-école", "Organisateur d’événements", "Service de traiteur", "Camion de restauration"],
      de: ["Café", "Restaurant", "Kaffeehaus", "Bäckerei", "Bar", "Pizzeria", "Friseursalon", "Barbershop", "Nagelstudio", "Spa", "Masseur", "Fitnessstudio", "Yoga-Studio", "Zahnarzt", "Arzt", "Apotheke", "Tierarzt", "Autowerkstatt", "Autowaschanlage", "Blumenladen", "Tierhandlung", "Buchhandlung", "Bekleidungsgeschäft", "Juwelier", "Möbelgeschäft", "Baumarkt", "Anwaltskanzlei", "Steuerberatung", "Immobilienagentur", "Versicherungsagentur", "Fotostudio", "Tattoo-Studio", "Reinigung", "Schlüsseldienst", "Reinigungsservice", "Landschaftsbau", "Klempner", "Elektriker", "Klimatechnik-Unternehmen", "Umzugsunternehmen", "Kindertagesstätte", "Nachhilfezentrum", "Fahrschule", "Eventplaner", "Catering-Service", "Food-Truck"],
      it: ["Caffetteria", "Ristorante", "Bar", "Panetteria", "Pub", "Pizzeria", "Parrucchiere", "Barbiere", "Salone per unghie", "Spa", "Massaggiatore", "Palestra", "Studio yoga", "Dentista", "Medico", "Farmacia", "Veterinario", "Officina auto", "Autolavaggio", "Fioraio", "Negozio per animali", "Libreria", "Negozio di abbigliamento", "Gioielleria", "Negozio di mobili", "Ferramenta", "Studio legale", "Studio commercialista", "Agenzia immobiliare", "Agenzia assicurativa", "Studio fotografico", "Studio tatuaggi", "Lavanderia", "Fabbro", "Servizio di pulizie", "Azienda di giardinaggio", "Idraulico", "Elettricista", "Azienda di climatizzazione", "Azienda di traslochi", "Asilo nido", "Centro di ripetizioni", "Autoscuola", "Organizzatore di eventi", "Servizio di catering", "Food truck"],
      pt: ["Cafeteria", "Restaurante", "Café", "Padaria", "Bar", "Pizzaria", "Salão de cabeleireiro", "Barbearia", "Salão de unhas", "Spa", "Massagista", "Academia", "Estúdio de ioga", "Dentista", "Médico", "Farmácia", "Veterinário", "Oficina mecânica", "Lava-jato", "Floricultura", "Pet shop", "Livraria", "Loja de roupas", "Joalheria", "Loja de móveis", "Loja de ferragens", "Escritório de advocacia", "Escritório de contabilidade", "Imobiliária", "Corretora de seguros", "Estúdio fotográfico", "Estúdio de tatuagem", "Lavanderia", "Chaveiro", "Serviço de limpeza", "Empresa de paisagismo", "Encanador", "Eletricista", "Empresa de climatização", "Empresa de mudanças", "Creche", "Centro de reforço escolar", "Autoescola", "Organizador de eventos", "Serviço de buffet", "Food truck"],
      tr: ["Kahve dükkanı", "Restoran", "Kafe", "Fırın", "Bar", "Pizza restoranı", "Kuaför salonu", "Berber", "Nail art salonu", "Spa", "Masaj terapisti", "Spor salonu", "Yoga stüdyosu", "Diş hekimi", "Doktor", "Eczane", "Veteriner", "Oto tamir dükkanı", "Araç yıkama", "Çiçekçi", "Petshop", "Kitapçı", "Giyim mağazası", "Kuyumcu", "Mobilya mağazası", "Hırdavat dükkanı", "Hukuk bürosu", "Muhasebe bürosu", "Emlak ofisi", "Sigorta acentesi", "Fotoğraf stüdyosu", "Dövme stüdyosu", "Kuru temizleme", "Çilingir", "Temizlik hizmeti", "Peyzaj şirketi", "Tesisatçı", "Elektrikçi", "İklimlendirme şirketi", "Nakliye şirketi", "Kreş", "Özel ders merkezi", "Sürücü kursu", "Etkinlik planlayıcısı", "Catering hizmeti", "Yemek kamyonu"],
      zh: ["咖啡店", "餐厅", "咖啡馆", "面包店", "酒吧", "披萨店", "美发沙龙", "理发店", "美甲店", "水疗中心", "按摩师", "健身房", "瑜伽馆", "牙医", "医生", "药店", "兽医", "汽车修理店", "洗车店", "花店", "宠物店", "书店", "服装店", "珠宝店", "家具店", "五金店", "律师事务所", "会计事务所", "房地产中介", "保险代理", "摄影工作室", "纹身店", "干洗店", "锁匠", "清洁服务", "园艺公司", "水管工", "电工", "暖通空调公司", "搬家公司", "日托中心", "辅导中心", "驾校", "活动策划", "餐饮服务", "餐车"],
      hi: ["कॉफी शॉप", "रेस्तरां", "कैफे", "बेकरी", "बार", "पिज़्ज़ा रेस्तरां", "हेयर सैलून", "बार्बरशॉप", "नेल सैलून", "स्पा", "मालिश चिकित्सक", "जिम", "योगा स्टूडियो", "दंत चिकित्सक", "डॉक्टर", "फार्मेसी", "पशु चिकित्सक", "ऑटो रिपेयर शॉप", "कार वॉश", "फूल की दुकान", "पालतू पशु स्टोर", "किताबों की दुकान", "कपड़ों की दुकान", "ज्वेलरी स्टोर", "फर्नीचर स्टोर", "हार्डवेयर स्टोर", "लॉ फर्म", "अकाउंटिंग फर्म", "रियल एस्टेट एजेंसी", "बीमा एजेंसी", "फोटोग्राफी स्टूडियो", "टैटू शॉप", "ड्राई क्लीनर", "लॉकस्मिथ", "सफाई सेवा", "भूनिर्माण कंपनी", "प्लंबर", "इलेक्ट्रीशियन", "HVAC कंपनी", "मूविंग कंपनी", "डेकेयर सेंटर", "ट्यूशन सेंटर", "ड्राइविंग स्कूल", "इवेंट प्लानर", "कैटरिंग सेवा", "फूड ट्रक"],
      ja: ["コーヒーショップ", "レストラン", "カフェ", "パン屋", "バー", "ピザ店", "美容室", "理容室", "ネイルサロン", "スパ", "マッサージ師", "ジム", "ヨガスタジオ", "歯科医", "医師", "薬局", "獣医", "自動車修理店", "洗車場", "花屋", "ペットショップ", "書店", "衣料品店", "宝石店", "家具店", "金物店", "法律事務所", "会計事務所", "不動産会社", "保険代理店", "写真スタジオ", "タトゥーショップ", "クリーニング店", "鍵屋", "清掃サービス", "造園会社", "配管工", "電気技師", "空調設備会社", "引越し会社", "保育園", "学習塾", "自動車教習所", "イベントプランナー", "ケータリングサービス", "フードトラック"],
      sv: ["Kafé", "Restaurang", "Café", "Bageri", "Bar", "Pizzeria", "Frisersalong", "Barberare", "Nagelsalong", "Spa", "Massageterapeut", "Gym", "Yogastudio", "Tandläkare", "Läkare", "Apotek", "Veterinär", "Bilverkstad", "Biltvätt", "Blomsteraffär", "Djuraffär", "Bokhandel", "Klädaffär", "Juvelerare", "Möbelaffär", "Järnaffär", "Advokatbyrå", "Revisionsbyrå", "Fastighetsmäklare", "Försäkringsbolag", "Fotostudio", "Tatueringsstudio", "Kemtvätt", "Låssmed", "Städservice", "Trädgårdsföretag", "Rörmokare", "Elektriker", "Ventilationsföretag", "Flyttfirma", "Förskola", "Läxhjälpscenter", "Trafikskola", "Eventplanerare", "Cateringtjänst", "Food truck"],
      no: ["Kaffebar", "Restaurant", "Café", "Bakeri", "Bar", "Pizzarestaurant", "Frisørsalong", "Barbershop", "Neglesalong", "Spa", "Massøse", "Treningssenter", "Yogastudio", "Tannlege", "Lege", "Apotek", "Veterinær", "Bilverksted", "Bilvask", "Blomsterbutikk", "Dyrebutikk", "Bokhandel", "Klesbutikk", "Gullsmed", "Møbelbutikk", "Jernvarehandel", "Advokatfirma", "Regnskapsfirma", "Eiendomsmegler", "Forsikringsagent", "Fotostudio", "Tatoveringsstudio", "Renseri", "Låsesmed", "Renholdstjeneste", "Landskapsarkitektfirma", "Rørlegger", "Elektriker", "Ventilasjonsfirma", "Flyttebyrå", "Barnehage", "Leksehjelpsenter", "Trafikkskole", "Eventplanlegger", "Cateringtjeneste", "Food truck"],
      da: ["Café", "Restaurant", "Kaffebar", "Bageri", "Bar", "Pizzeria", "Frisørsalon", "Barber", "Neglesalon", "Spa", "Massageterapeut", "Fitnesscenter", "Yogastudie", "Tandlæge", "Læge", "Apotek", "Dyrlæge", "Autoværksted", "Bilvask", "Blomsterbutik", "Dyrehandel", "Boghandel", "Tøjbutik", "Guldsmed", "Møbelbutik", "Isenkræmmer", "Advokatfirma", "Revisionsfirma", "Ejendomsmæglerkontor", "Forsikringsagentur", "Fotostudie", "Tatoveringsbutik", "Renseri", "Låsesmed", "Rengøringsservice", "Anlægsgartnerfirma", "Blikkenslager", "Elektriker", "Ventilationsfirma", "Flyttefirma", "Børnehave", "Lektiehjælpscenter", "Køreskole", "Eventplanlægger", "Cateringservice", "Food truck"],
      fi: ["Kahvila", "Ravintola", "Kahvibaari", "Leipomo", "Baari", "Pizzeria", "Kampaamo", "Parturi", "Kynsistudio", "Spa", "Hieroja", "Kuntosali", "Joogastudio", "Hammaslääkäri", "Lääkäri", "Apteekki", "Eläinlääkäri", "Autokorjaamo", "Autopesu", "Kukkakauppa", "Lemmikkikauppa", "Kirjakauppa", "Vaatekauppa", "Kultaseppä", "Huonekalukauppa", "Rautakauppa", "Asianajotoimisto", "Tilitoimisto", "Kiinteistönvälitys", "Vakuutusedustaja", "Valokuvausstudio", "Tatuointiliike", "Kuivapesula", "Lukkoseppä", "Siivouspalvelu", "Puutarhayritys", "Putkimies", "Sähköasentaja", "LVI-yritys", "Muuttopalvelu", "Päiväkoti", "Tukiopetuskeskus", "Autokoulu", "Tapahtumasuunnittelija", "Pitopalvelu", "Ruokarekka"],
      uk: ["Кав’ярня", "Ресторан", "Кафе", "Пекарня", "Бар", "Піцерія", "Перукарня", "Барбершоп", "Салон манікюру", "Спа", "Масажист", "Спортзал", "Йога-студія", "Стоматолог", "Лікар", "Аптека", "Ветеринар", "Автосервіс", "Автомийка", "Квітковий магазин", "Зоомагазин", "Книгарня", "Магазин одягу", "Ювелірний магазин", "Меблевий магазин", "Господарський магазин", "Юридична фірма", "Бухгалтерська фірма", "Агентство нерухомості", "Страхова агенція", "Фотостудія", "Тату-салон", "Хімчистка", "Служба замків", "Клінінгова служба", "Ландшафтна компанія", "Сантехнік", "Електрик", "Компанія з вентиляції та кондиціонування", "Переїзди", "Дитячий садок", "Центр репетиторства", "Автошкола", "Організація заходів", "Кейтеринг", "Фудтрак"],
      el: ["Καφετέρια", "Εστιατόριο", "Καφέ", "Αρτοποιείο", "Μπαρ", "Πιτσαρία", "Κομμωτήριο", "Κουρείο", "Σαλόνι νυχιών", "Σπα", "Μασέρ", "Γυμναστήριο", "Στούντιο γιόγκα", "Οδοντίατρος", "Γιατρός", "Φαρμακείο", "Κτηνίατρος", "Συνεργείο αυτοκινήτων", "Πλυντήριο αυτοκινήτων", "Ανθοπωλείο", "Κατάστημα κατοικίδιων", "Βιβλιοπωλείο", "Κατάστημα ρούχων", "Κοσμηματοπωλείο", "Κατάστημα επίπλων", "Κατάστημα εργαλείων", "Δικηγορικό γραφείο", "Λογιστικό γραφείο", "Μεσιτικό γραφείο", "Ασφαλιστικός πράκτορας", "Φωτογραφικό στούντιο", "Κατάστημα τατουάζ", "Στεγνοκαθαριστήριο", "Κλειδαράς", "Υπηρεσία καθαρισμού", "Εταιρεία κηπουρικής", "Υδραυλικός", "Ηλεκτρολόγος", "Εταιρεία κλιματισμού", "Εταιρεία μετακομίσεων", "Παιδικός σταθμός", "Κέντρο ενισχυτικής διδασκαλίας", "Σχολή οδηγών", "Οργανωτής εκδηλώσεων", "Υπηρεσία catering", "Φορτηγάκι φαγητού"],
      be: ["Кавярня", "Рэстаран", "Кафэ", "Пякарня", "Бар", "Піцэрыя", "Цырульня", "Барбершоп", "Салон манікюру", "Спа", "Масажыст", "Спартзала", "Ёга-студыя", "Стаматолаг", "Урач", "Аптэка", "Ветэрынар", "Аўтасэрвіс", "Аўтамыйка", "Кветкавая крама", "Заамагазін", "Кнігарня", "Крама адзення", "Ювелірная крама", "Мэблевая крама", "Гаспадарчая крама", "Юрыдычная фірма", "Бухгалтарская фірма", "Агенцтва нерухомасці", "Страхавая агенцыя", "Фотастудыя", "Тату-салон", "Хімчыстка", "Служба замкоў", "Клінінгавая служба", "Ландшафтная кампанія", "Сантэхнік", "Электрык", "Кампанія па вентыляцыі і кандыцыянаванні", "Пераезды", "Дзіцячы сад", "Цэнтр рэпетытарства", "Аўташкола", "Арганізацыя мерапрыемстваў", "Кейтэрынг", "Фудтрак"],
    };

  const BRAND_VOICE_OPTIONS_BY_LANG = {
      en: ["Friendly, playful", "Professional, polished", "Warm, welcoming", "Bold, energetic", "Elegant, sophisticated", "Down-to-earth, casual", "Witty, fun", "Calm, reassuring", "Luxurious, exclusive", "Minimalist, direct"],
      ru: ["Дружелюбный, игривый", "Профессиональный, отточенный", "Тёплый, гостеприимный", "Смелый, энергичный", "Элегантный, изысканный", "Простой, непринуждённый", "Остроумный, весёлый", "Спокойный, уверенный", "Роскошный, эксклюзивный", "Минималистичный, прямой"],
      ar: ["ودود ومرح", "احترافي وأنيق", "دافئ ومرحب", "جريء ونشيط", "أنيق ومتطور", "بسيط وغير رسمي", "ذكي ومسلٍّ", "هادئ ومطمئن", "فاخر وحصري", "بسيط ومباشر"],
      fa: ["دوستانه، بازیگوش", "حرفه‌ای، صیقلی", "گرم، خوش‌آمدگو", "جسور، پرانرژی", "شیک، پیچیده", "ساده، غیررسمی", "شوخ‌طبع، سرگرم‌کننده", "آرام، اطمینان‌بخش", "لوکس، اختصاصی", "مینیمال، مستقیم"],
      es: ["Amigable, divertido", "Profesional, pulido", "Cálido, acogedor", "Audaz, enérgico", "Elegante, sofisticado", "Sencillo, casual", "Ingenioso, divertido", "Tranquilo, reconfortante", "Lujoso, exclusivo", "Minimalista, directo"],
      fr: ["Amical, ludique", "Professionnel, soigné", "Chaleureux, accueillant", "Audacieux, énergique", "Élégant, raffiné", "Simple, décontracté", "Spirituel, amusant", "Calme, rassurant", "Luxueux, exclusif", "Minimaliste, direct"],
      de: ["Freundlich, verspielt", "Professionell, poliert", "Warm, einladend", "Mutig, energiegeladen", "Elegant, raffiniert", "Bodenständig, leger", "Witzig, unterhaltsam", "Ruhig, beruhigend", "Luxuriös, exklusiv", "Minimalistisch, direkt"],
      it: ["Amichevole, giocoso", "Professionale, curato", "Caloroso, accogliente", "Audace, energico", "Elegante, raffinato", "Semplice, casual", "Spiritoso, divertente", "Calmo, rassicurante", "Lussuoso, esclusivo", "Minimalista, diretto"],
      pt: ["Amigável, divertido", "Profissional, refinado", "Caloroso, acolhedor", "Ousado, energético", "Elegante, sofisticado", "Simples, casual", "Espirituoso, divertido", "Calmo, tranquilizador", "Luxuoso, exclusivo", "Minimalista, direto"],
      tr: ["Samimi, eğlenceli", "Profesyonel, kusursuz", "Sıcak, davetkar", "Cesur, enerjik", "Zarif, sofistike", "Sade, rahat", "Esprili, eğlenceli", "Sakin, güven verici", "Lüks, özel", "Minimalist, doğrudan"],
      zh: ["友好、俏皮", "专业、精致", "温暖、亲切", "大胆、有活力", "优雅、精致", "朴实、随意", "机智、有趣", "平静、令人安心", "奢华、独特", "简约、直接"],
      hi: ["मैत्रीपूर्ण, चंचल", "पेशेवर, परिष्कृत", "गर्मजोशी भरा, स्वागत करने वाला", "साहसी, ऊर्जावान", "सुरुचिपूर्ण, परिष्कृत", "सरल, आकस्मिक", "चतुर, मज़ेदार", "शांत, आश्वस्त करने वाला", "शानदार, विशिष्ट", "न्यूनतम, सीधा"],
      ja: ["フレンドリーで遊び心のある", "プロフェッショナルで洗練された", "温かく歓迎的な", "大胆でエネルギッシュな", "エレガントで洗練された", "飾らずカジュアルな", "ウィットに富んだ楽しい", "落ち着いて安心感のある", "豪華で特別な", "ミニマルで直接的な"],
      sv: ["Vänlig, lekfull", "Professionell, polerad", "Varm, välkomnande", "Djärv, energisk", "Elegant, sofistikerad", "Jordnära, avslappnad", "Kvick, rolig", "Lugn, betryggande", "Lyxig, exklusiv", "Minimalistisk, rakt på sak"],
      no: ["Vennlig, leken", "Profesjonell, polert", "Varm, imøtekommende", "Modig, energisk", "Elegant, sofistikert", "Nedpå, avslappet", "Vittig, morsom", "Rolig, betryggende", "Luksuriøs, eksklusiv", "Minimalistisk, direkte"],
      da: ["Venlig, legesyg", "Professionel, poleret", "Varm, imødekommende", "Modig, energisk", "Elegant, sofistikeret", "Jordnær, afslappet", "Vittig, sjov", "Rolig, betryggende", "Luksuriøs, eksklusiv", "Minimalistisk, direkte"],
      fi: ["Ystävällinen, leikkisä", "Ammattimainen, hiottu", "Lämmin, kutsuva", "Rohkea, energinen", "Tyylikäs, hienostunut", "Maanläheinen, rento", "Nokkela, hauska", "Rauhallinen, rauhoittava", "Ylellinen, eksklusiivinen", "Minimalistinen, suora"],
      uk: ["Дружній, грайливий", "Професійний, вишуканий", "Теплий, гостинний", "Сміливий, енергійний", "Елегантний, вишуканий", "Простий, невимушений", "Дотепний, веселий", "Спокійний, впевнений", "Розкішний, ексклюзивний", "Мінімалістичний, прямий"],
      el: ["Φιλικό, παιχνιδιάρικο", "Επαγγελματικό, στιλάτο", "Ζεστό, φιλόξενο", "Τολμηρό, ενεργητικό", "Κομψό, εκλεπτυσμένο", "Απλό, χαλαρό", "Πνευματώδες, διασκεδαστικό", "Ήρεμο, καθησυχαστικό", "Πολυτελές, αποκλειστικό", "Μινιμαλιστικό, άμεσο"],
      be: ["Сяброўскі, гарэзлівы", "Прафесійны, дасканалы", "Цёплы, гасцінны", "Смелы, энергічны", "Элегантны, вытанчаны", "Просты, нязмушаны", "Дасціпны, вясёлы", "Спакойны, упэўнены", "Раскошны, эксклюзіўны", "Мінімалістычны, прамы"],
    };
  ...
  function handleCategoryChange(value) {
    ...
    const CATEGORY_OPTIONS = CATEGORY_OPTIONS_BY_LANG[language] || CATEGORY_OPTIONS_BY_LANG.en;
  ...
  function handleBrandVoiceChange(value) {
    ...
    const BRAND_VOICE_OPTIONS = BRAND_VOICE_OPTIONS_BY_LANG[language] || BRAND_VOICE_OPTIONS_BY_LANG.en;
        ...
        <div style={{ padding: '32px 24px 64px', minHeight: '60vh', background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', overflow: 'hidden', position: 'relative', boxSizing: 'border-box' }}>
          ...
          {!unlocked && (
            ...
            {freeTrialUsed ? (
              <div className="flex items-start gap-2.5">
                <span style={{ flexShrink: 0, width: 18, height: 18, borderRadius: '50%', marginTop: 1, background: AMBER, display: 'inline-block' }} />
                <div style={{ flex: 1 }}>
                  <p className="text-sm" style={{ color: '#C0472F', margin: '0 0 10px', fontWeight: 600, fontFamily: bodyFont }}>Your free preview is over. Enter your code whenever you're ready to keep going.</p>
                  <a
                    href="/unlock.html"
                    className="inline-block font-semibold px-4 py-2 rounded text-sm"
                    style={{ background: `linear-gradient(135deg, ${AMBER}, ${AMBER_DEEP})`, color: TEXT_LIGHT, textDecoration: 'none' }}
                  >
                    Enter your code →
                  </a>
              ...
              <div className="flex items-center gap-2.5">
                <span style={{ flexShrink: 0, width: 18, height: 18, borderRadius: '50%', background: `linear-gradient(135deg, ${AMBER}, ${AMBER_DEEP})`, display: 'inline-block' }} />
          ...
          {showWelcome && (
            <div style={{
              ...
              background: 'rgba(20,18,15,0.55)', backdropFilter: 'blur(4px)', animation: 'welcomeFadeIn 0.4s ease both',
            }}>
              <style>{`
              ...
              <div style={{ position: 'relative', textAlign: 'center', animation: 'welcomeFadeOut 0.4s ease 3.4s both' }}>
                ...
                <div style={{
                  ...
                  boxShadow: `0 12px 32px rgba(242,169,59,0.4)`, animation: 'ringPop 0.55s cubic-bezier(0.34,1.56,0.64,1) both',
                }}>
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke={TEXT_LIGHT} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" style={{ strokeDasharray: 40, animation: 'checkDraw 0.5s ease 0.35s both' }} />
                  </svg>
                </div>
                <h2 style={{ fontFamily: bodyFont, fontSize: 26, fontWeight: 600, color: TEXT_LIGHT, margin: '0 0 6px', animation: 'textRise 0.4s ease 0.5s both' }}>Welcome</h2>
